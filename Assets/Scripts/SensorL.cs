...
{ 
    ...
    private void OnTriggerStay(Collider other)
    {
        ...
        else if (!touchedLastFrame && Input.touchCount > 0)
        {
            ...
            if (firstTouch.position.x < midScreenPosX && firstTouch.position.x > leftMidScreenPosX && !touched && jugeArea == JugeArea.Perfect)
            {
            ...
            else if (firstTouch.position.x < midScreenPosX && firstTouch.position.x > leftMidScreenPosX && !touched && jugeArea == JugeArea.Good)
            {
            ...
            else if (firstTouch.position.x < midScreenPosX && firstTouch.position.x > leftMidScreenPosX && !touched && jugeArea == JugeArea.Miss)
            {
