...
{   
    ...
    private void OnTriggerStay(Collider other)
    {
        ...
        else if (secondTouchedLastFrame && Input.touchCount == 3 && !thirdTouchedLastFrame)//第二下還按著接著到第三下進來
        {
            ...
            if (thirTouch.position.x > midScreenPosX && secondTouch.position.x < rightMidScreenPosX && firstTouch.position.y < midScreenPosY && jugeArea == JugeArea.Perfect)
            {
                Debug.Log("Perfect" + "，觸碰位置: " + firstTouch.position);
                gameCanvas.rythmPoint += other.GetComponentInParent<ObstaclePrefabDrop>().perfectPoint;
            ...
            else if (thirTouch.position.x > midScreenPosX && secondTouch.position.x < rightMidScreenPosX && firstTouch.position.y < midScreenPosY && jugeArea == JugeArea.Good)
            {
                Debug.Log("Good" + "，觸碰位置: " + firstTouch.position);
                gameCanvas.rythmPoint += other.GetComponentInParent<ObstaclePrefabDrop>().goodPoint;
            ...
            else if (thirTouch.position.x > midScreenPosX && secondTouch.position.x < rightMidScreenPosX && firstTouch.position.y < midScreenPosY && jugeArea == JugeArea.Miss)
            {
                Debug.Log("Miss" + "，觸碰位置: " + firstTouch.position);
                gameCanvas.rythmPoint -= other.GetComponentInParent<ObstaclePrefabDrop>().missPoint;
        ...
        else if (thirdTouchedLastFrame && Input.touchCount == 4 && !fourthTouchedLastFrame)//第三下還按著接著到第四下進來
        {
            ...
            if (fourthTouch.position.x > midScreenPosX && secondTouch.position.x < rightMidScreenPosX && firstTouch.position.y < midScreenPosY && jugeArea == JugeArea.Perfect)
            {
                Debug.Log("Perfect" + "，觸碰位置: " + firstTouch.position);
                gameCanvas.rythmPoint += other.GetComponentInParent<ObstaclePrefabDrop>().perfectPoint;
            ...
            else if (fourthTouch.position.x > midScreenPosX && secondTouch.position.x < rightMidScreenPosX && firstTouch.position.y < midScreenPosY && jugeArea == JugeArea.Good)
            {
                Debug.Log("Good" + "，觸碰位置: " + firstTouch.position);
                gameCanvas.rythmPoint += other.GetComponentInParent<ObstaclePrefabDrop>().goodPoint;
            ...
            else if (fourthTouch.position.x > midScreenPosX && secondTouch.position.x < rightMidScreenPosX && firstTouch.position.y < midScreenPosY && jugeArea == JugeArea.Miss)
            {
                Debug.Log("Miss" + "，觸碰位置: " + firstTouch.position);
                gameCanvas.rythmPoint -= other.GetComponentInParent<ObstaclePrefabDrop>().missPoint;
