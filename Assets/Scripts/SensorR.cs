...
{   
    ...
    private void OnTriggerStay(Collider other)
    {
        ...
        else if (!touchedLastFrame && Input.touchCount > 0)
        {
            ...
            firstTouch = Input.GetTouch(0);
            if (firstTouch.position.x > midScreenPosX && firstTouch.position.x < rightMidScreenPosX && !touched && jugeArea == JugeArea.Perfect)
            {
                Debug.Log("Perfect" + "，觸碰位置: " + firstTouch.position);
                testBonusPoint += 5;
                touched = true;
            ...
            else if (firstTouch.position.x > midScreenPosX && firstTouch.position.x < rightMidScreenPosX && !touched && jugeArea == JugeArea.Good)
            {
            ...
            else if (firstTouch.position.x > midScreenPosX && firstTouch.position.x < rightMidScreenPosX && !touched && jugeArea == JugeArea.Miss)
            {
